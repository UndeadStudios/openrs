...
public class NpcDefDumperEXILE {
	...
	public static final String EXPORT = "E:/dump/export/NpcDefinitionsEXILE.json";
...
//			        	System.out.println("Couldn't fetch page for: " + name);
			    	...
			    	if(npc.attackable) {
				    	...
				    	json.name("undead");
				    	json.value(npc.undead);
				    	json.name("poisonImmunity");
				    	json.value(npc.poisonImmunity);
				    	json.name("venomImmunity");
				    	json.value(npc.venomImmunity);
