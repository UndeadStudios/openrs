...
public class ItemDefDumperPopup {
	
	public static final String EXPORT = "./repository/types/";
	...
	public static void main(String[] args) throws Exception {
		...
		String exportFile = JOptionPane.showInputDialog("File name");
		String name = JOptionPane.showInputDialog("name");
		String id = JOptionPane.showInputDialog("id");
		String members = JOptionPane.showInputDialog("members");
		String tradable = JOptionPane.showInputDialog("tradable");
		String stackable = JOptionPane.showInputDialog("stackable");
		String equipable = JOptionPane.showInputDialog("equipable");
		String highAlch = JOptionPane.showInputDialog("highAlch");
		String lowAlch = JOptionPane.showInputDialog("lowAlch");
		String geprice = JOptionPane.showInputDialog("geprice");
		String shopValue = JOptionPane.showInputDialog("shopValue");
		String weight = JOptionPane.showInputDialog("weight");
		String examine = JOptionPane.showInputDialog("examine");
		String slot = JOptionPane.showInputDialog("slot");
		String twoHanded = JOptionPane.showInputDialog("twoHanded");
		String helm = JOptionPane.showInputDialog("helm");
		...
		String bonusses = JOptionPane.showInputDialog("bonusses");
		boolean oldBonusses = false;
		if (!bonusses.isEmpty()) {
			int dialogButton = JOptionPane.YES_NO_OPTION;
			oldBonusses = JOptionPane.showConfirmDialog(null, "Do you want the old bonusses?", "Old bonusses", dialogButton) == 0;
		}
		String requirements = JOptionPane.showInputDialog("requirements");
		String note = JOptionPane.showInputDialog("note");
		String noteable = JOptionPane.showInputDialog("noteable");
		String unnotedId = JOptionPane.showInputDialog("unnotedId");
		String notedId = JOptionPane.showInputDialog("notedId");
		
		JsonWriter json = new JsonWriter(new FileWriter(EXPORT + exportFile + ".json"));
		json.setIndent("  ");
		json.beginArray();
...
//				        					System.out.println("----");
			    	...
			    	if(item.note) {
			    		int id2 = item.id;
			    		int notedId2 = item.notedId;
			    		item = items.get(notedId2);
			    		item.id = id2;
			    		item.notedId = notedId2;
			    		item.unnotedId = notedId2;
			    		item.note = true;
			    		item.stackable = true;
