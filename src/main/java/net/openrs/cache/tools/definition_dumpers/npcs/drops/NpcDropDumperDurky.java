...
public class NpcDropDumperDurky {
	
	public static final String EXPORT = "E:/dump/export/NpcDropsDurky.json";
...
//					        				System.out.println(id + " - " + dropName + ": " + minAmount + " to " + maxAmount + " | Chance (percentage): " + rarityChance);
					        				if(rarityLevel == "COMMON" || rarityLevel == "ALWAYS" || rarityLevel == "UNCOMMON")
						        ...
						        if(!npcDropsCommon.isEmpty() || !npcDropsRare.isEmpty()) {
