...
public class ItemDefDumperExtJaamakut {
	
	public static final String EXPORT = "E:/dump/export/ItemDefsJaamakutt.json";
				        ...
				        for (org.jsoup.nodes.Element infoBox : list) {
				        	...
				        	if(examineNext) {
				        		...
				        		if(text.contains("Members only")) {
				        			...
				        			if (descr != "" && !(descr.toLowerCase().contains("enchant") && (item.slot == "AMULET" || item.slot == "RING"))) {
