...
public class NpcDropDumperEXILE {
	...
	public static final String EXPORT = "D:/dump/export/NpcDropsEXILE.json";
	
	public static final String LISTFILE = "./repository/types/npcs.txt";
	
	public static final int MAXNPCS = 7848;
